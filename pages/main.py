...
layout = html.Div([
    html.H1("Play around with Parts of Speech", style={"color": "BLue",'font-size':'16px'}),
    html.Div([
    html.Div([
    dcc.Textarea(
        id='textarea-state-example',
        value='Enter text here',
        style={'width': '40%','height': 300,'background-color':'LightYellow',"border":"None",'color':'Blue',\
              'font-size':'16px','display': 'inline-block',"line-height": "30px"}),
    ...
    html.Button('Submit', id='textarea-state-example-button', n_clicks=0,\
                style={"background-color":"Blue","border": "none","color": "Yellow","padding": "5px 15px",\
