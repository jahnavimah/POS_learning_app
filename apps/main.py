...
layout = html.Div([
    ...
    dcc.Textarea(
        ...
        style={'width': '45%','height': 300,'background-color':'LightYellow',"border":"None",'color':'Purple',\
              'font-size':'16px','display': 'inline-block',"line-height": "30px",'font-weight': 'bold',\
              'font-family': 'Arial','left': '20px'}),
    #html.Div(id='middle_area', style={'display': 'inline-block','width': '5%','height': 100}),\
                                     #'background-image': 'url("/assets/rainbowfin.gif")'}),
    ...
    html.Div(id='right_area', style={'display': 'inline-block','width': '28%','height': 100,
    ...
    dcc.Dropdown(id='my-button',
               ...
               value='',className="select_box",
                ...
                style={"background-color":"LightYellow","border": "none",'font-family': 'Arial','left': '20px'}),
